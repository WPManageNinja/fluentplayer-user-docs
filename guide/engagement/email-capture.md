...
2. Select the **FluentPlayer** block and expand the **Interactive Layers** panel under the **Block** tab in the right sidebar.
...
You can add multiple providers to a single Email Capture layer if needed:
