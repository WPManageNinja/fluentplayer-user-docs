...
While you are logged in as an administrator, the **WordPress admin bar** (top of the screen on the front end) may include a quick link to **Fluent Player** for faster access to media and settings, which is useful when previewing a page and jumping straight into the plugin.
