...
* **Loop:** The video **starts again from the beginning** immediately (useful for background or ambient clips). The [Ambient](/presets) preset uses loop style end behavior by default.
