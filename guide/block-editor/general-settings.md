 ...
 * **Title Overlay:** When enabled, the video title will appear in the top left corner of the player when the video is paused or hovered over. You can use the "tag" icon to insert dynamic **[Smartcodes](/smartcodes-personalization)** for personalized titles.
