...
description: "Upload VTT or SRT captions in the Block sidebar, manage multiple tracks, and pair subtitles with multi-language tracks."
---
 ...
 * **Multiple Tracks:** You can repeat the upload process to add subtitle files for different languages. If you want to know more about **Multi-Language**, read this [Documentation](/multi-language).
...
The appearance of your captions such as font size, color, and overall style is not controlled only in the subtitle upload panel. You can customize these settings from the [Presets](/presets) or the [Branding & Appearance](/branding-appearance) section to match your video player design.
